...
import { ArrowRight, BarChart, Map, MessagesSquare, Users, Zap } from "lucide-react";
  ...
  return (
    <div className="space-y-12">
      ...
      <GradientHeader title="Shape the Future of our product"
        subtitle="Fusion Feedback  is  where Your idea comes to life . Suggest Features, Vote on
           What Matter most ,and  follow  our public Roadmap .  ">
